...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive bugs document focusing on {topic}..."
    enhancement: |
      "Enhance the bugs {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [bugs] project, ensuring all stakeholders are aligned."
