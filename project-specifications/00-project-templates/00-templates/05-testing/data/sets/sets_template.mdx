...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive sets document focusing on {topic}..."
    enhancement: |
      "Enhance the sets {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [sets] project, ensuring all stakeholders are aligned."
