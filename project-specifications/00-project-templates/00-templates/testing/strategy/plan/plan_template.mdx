...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive plan document focusing on {topic}..."
    enhancement: |
      "Enhance the plan {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [plan] project, ensuring all stakeholders are aligned."
