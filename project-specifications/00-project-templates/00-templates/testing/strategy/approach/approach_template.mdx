...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive approach document focusing on {topic}..."
    enhancement: |
      "Enhance the approach {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [approach] project, ensuring all stakeholders are aligned."
