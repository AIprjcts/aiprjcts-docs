...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive unit document focusing on {topic}..."
    enhancement: |
      "Enhance the unit {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [unit] project, ensuring all stakeholders are aligned."
