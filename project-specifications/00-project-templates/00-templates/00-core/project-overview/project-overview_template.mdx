...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive project-overview document focusing on {topic}..."
    enhancement: |
      "Enhance the project-overview {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [project-overview] project, ensuring all stakeholders are aligned."
