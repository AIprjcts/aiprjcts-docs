...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive stakeholders document focusing on {topic}..."
    enhancement: |
      "Enhance the stakeholders {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [stakeholders] project, ensuring all stakeholders are aligned."
