...
ai:
  ...
  validationRules:
    mustSections: 
        - id: "${MUST_SECTION_1}"
          errorMessage: "Section ${MUST_SECTION_1} is required"
  ...
  promptTemplates:
    creation: |  
      context: "${CONTEXT}"
      instruction: "Create a ${DOCUMENT_TYPE} for ${SYSTEM_TYPE}"
      focus: "${FOCUS_AREA}"
      constraints: 
        - "${CONSTRAINT_1}"
        - "${CONSTRAINT_2}"
  ...
  inheritance:
   ...
   errorHandling:
      ...
      generation:
      fallbackOptions: ["${FALLBACK_1}", "${FALLBACK_2}"]
