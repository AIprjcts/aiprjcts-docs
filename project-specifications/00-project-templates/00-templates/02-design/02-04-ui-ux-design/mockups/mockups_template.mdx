...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive mockups document focusing on {topic}..."
    enhancement: |
      "Enhance the mockups {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [mockups] project, ensuring all stakeholders are aligned."
