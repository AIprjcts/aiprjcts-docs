...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive setup document focusing on {topic}..."
    enhancement: |
      "Enhance the setup {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [setup] project, ensuring all stakeholders are aligned."
