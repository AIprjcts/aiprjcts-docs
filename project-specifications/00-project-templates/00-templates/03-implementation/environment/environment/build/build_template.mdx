...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive build document focusing on {topic}..."
    enhancement: |
      "Enhance the build {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [build] project, ensuring all stakeholders are aligned."
