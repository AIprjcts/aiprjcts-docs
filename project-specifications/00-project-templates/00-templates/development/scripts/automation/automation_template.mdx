...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive automation document focusing on {topic}..."
    enhancement: |
      "Enhance the automation {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [automation] project, ensuring all stakeholders are aligned."
