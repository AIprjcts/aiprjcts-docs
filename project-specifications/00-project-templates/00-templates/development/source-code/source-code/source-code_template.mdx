...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive source-code document focusing on {topic}..."
    enhancement: |
      "Enhance the source-code {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [source-code] project, ensuring all stakeholders are aligned."
