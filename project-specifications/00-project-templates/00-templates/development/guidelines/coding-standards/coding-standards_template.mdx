...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive coding-standards document focusing on {topic}..."
    enhancement: |
      "Enhance the coding-standards {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [coding-standards] project, ensuring all stakeholders are aligned."
