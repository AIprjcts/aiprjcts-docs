...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive style-guide document focusing on {topic}..."
    enhancement: |
      "Enhance the style-guide {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [style-guide] project, ensuring all stakeholders are aligned."
