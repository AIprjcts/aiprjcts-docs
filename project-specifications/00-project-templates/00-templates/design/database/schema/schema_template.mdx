...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive schema document focusing on {topic}..."
    enhancement: |
      "Enhance the schema {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [schema] project, ensuring all stakeholders are aligned."
