...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive diagrams document focusing on {topic}..."
    enhancement: |
      "Enhance the diagrams {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [diagrams] project, ensuring all stakeholders are aligned."
