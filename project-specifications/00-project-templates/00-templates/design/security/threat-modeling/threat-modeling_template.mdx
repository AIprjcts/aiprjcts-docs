...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive threat-modeling document focusing on {topic}..."
    enhancement: |
      "Enhance the threat-modeling {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [threat-modeling] project, ensuring all stakeholders are aligned."
