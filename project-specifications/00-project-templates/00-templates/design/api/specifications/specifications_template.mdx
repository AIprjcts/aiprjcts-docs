...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive specifications document focusing on {topic}..."
    enhancement: |
      "Enhance the specifications {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [specifications] project, ensuring all stakeholders are aligned."
