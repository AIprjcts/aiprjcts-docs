...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive documentation document focusing on {topic}..."
    enhancement: |
      "Enhance the documentation {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [documentation] project, ensuring all stakeholders are aligned."
