...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive acronyms document focusing on {topic}..."
    enhancement: |
      "Enhance the acronyms {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [acronyms] project, ensuring all stakeholders are aligned."
