...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive personas document focusing on {topic}..."
    enhancement: |
      "Enhance the personas {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [personas] project, ensuring all stakeholders are aligned."
