...
# AI Instructions
ai:
  documentType: "roles-and-responsibilities"
  validationRules:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive roles-and-responsibilities document focusing on {topic}..."
    enhancement: |
      "Enhance the roles-and-responsibilities {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [roles-and-responsibilities] project, ensuring all stakeholders are aligned."
