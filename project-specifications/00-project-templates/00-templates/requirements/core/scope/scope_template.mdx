...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive scope document focusing on {topic}..."
    enhancement: |
      "Enhance the scope {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [scope] project, ensuring all stakeholders are aligned."
