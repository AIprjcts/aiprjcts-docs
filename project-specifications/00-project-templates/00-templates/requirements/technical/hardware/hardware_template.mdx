...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive hardware document focusing on {topic}..."
    enhancement: |
      "Enhance the hardware {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [hardware] project, ensuring all stakeholders are aligned."
