...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive compliance document focusing on {topic}..."
    enhancement: |
      "Enhance the compliance {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [compliance] project, ensuring all stakeholders are aligned."
