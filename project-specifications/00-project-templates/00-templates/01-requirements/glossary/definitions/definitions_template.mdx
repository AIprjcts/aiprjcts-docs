...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive definitions document focusing on {topic}..."
    enhancement: |
      "Enhance the definitions {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [definitions] project, ensuring all stakeholders are aligned."
