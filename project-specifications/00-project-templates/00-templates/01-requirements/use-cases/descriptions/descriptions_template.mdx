...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive descriptions document focusing on {topic}..."
    enhancement: |
      "Enhance the descriptions {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [descriptions] project, ensuring all stakeholders are aligned."
