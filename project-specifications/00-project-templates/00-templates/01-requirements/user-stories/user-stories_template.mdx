...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive user-stories document focusing on {topic}..."
    enhancement: |
      "Enhance the user-stories {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [user-stories] project, ensuring all stakeholders are aligned."
