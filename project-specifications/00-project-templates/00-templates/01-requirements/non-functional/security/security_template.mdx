...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive security document focusing on {topic}..."
    enhancement: |
      "Enhance the security {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [security] project, ensuring all stakeholders are aligned."
