...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive performance document focusing on {topic}..."
    enhancement: |
      "Enhance the performance {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [performance] project, ensuring all stakeholders are aligned."
