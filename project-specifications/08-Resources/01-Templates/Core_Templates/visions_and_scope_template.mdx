...
ai:   
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive visions and scope or business document focusing on {topic}..."
    enhancement: |
      "Enhance the objectives {teamplate_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [objectives] project, ensuring all stakeholders are aligned."
