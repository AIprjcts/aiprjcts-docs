...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive integration document focusing on {topic}..."
    enhancement: |
      "Enhance the integration {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [integration] project, ensuring all stakeholders are aligned."
