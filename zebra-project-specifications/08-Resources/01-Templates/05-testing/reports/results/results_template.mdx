...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive results document focusing on {topic}..."
    enhancement: |
      "Enhance the results {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [results] project, ensuring all stakeholders are aligned."
