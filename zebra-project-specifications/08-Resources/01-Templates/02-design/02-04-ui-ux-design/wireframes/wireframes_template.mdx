...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive wireframes document focusing on {topic}..."
    enhancement: |
      "Enhance the wireframes {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [wireframes] project, ensuring all stakeholders are aligned."
