...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive system document focusing on {topic}..."
    enhancement: |
      "Enhance the system {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [system] project, ensuring all stakeholders are aligned."
