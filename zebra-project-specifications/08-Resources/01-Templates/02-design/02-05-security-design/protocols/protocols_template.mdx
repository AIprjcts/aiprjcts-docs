...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive protocols document focusing on {topic}..."
    enhancement: |
      "Enhance the protocols {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [protocols] project, ensuring all stakeholders are aligned."
