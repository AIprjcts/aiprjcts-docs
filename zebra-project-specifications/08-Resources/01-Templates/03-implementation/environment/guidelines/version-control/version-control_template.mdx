...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive version-control document focusing on {topic}..."
    enhancement: |
      "Enhance the version-control {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [version-control] project, ensuring all stakeholders are aligned."
