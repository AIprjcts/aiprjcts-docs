...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive tools document focusing on {topic}..."
    enhancement: |
      "Enhance the tools {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [tools] project, ensuring all stakeholders are aligned."
