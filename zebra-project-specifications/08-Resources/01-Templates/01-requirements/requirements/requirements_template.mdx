...
ai:
  ...
  promptTemplates:
    creation: |
      "Generate a comprehensive requirements document focusing on {topic}..."
    enhancement: |
      "Enhance the requirements {template_id} by adding details about {aspect}..."
---
...
**Example:**
> "This document outlines the requirements and objectives for the [requirements] project, ensuring all stakeholders are aligned."
